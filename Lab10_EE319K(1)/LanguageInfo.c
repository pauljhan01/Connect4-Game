...
const char HH_English[] = "Human vs. Human";
const char HH_French[] = "Humain contre Humain";
const char HM_English[] = "Human vs. Machine";
const char HM_French[] = "Humain contre Machine";
